// Liste officielle des 58 wilayas d'Algerie (code officiel + nom).
// Source unique reutilisee par le seed et la creation de wilaya cote admin.
export interface OfficialWilaya {
  id: number;
  name: string;
}

export const ALGERIAN_WILAYAS: OfficialWilaya[] = [
  { id: 1, name: "Adrar" },
  { id: 2, name: "Chlef" },
  { id: 3, name: "Laghouat" },
...
export const OFFICIAL_WILAYA_BY_ID = new Map(ALGERIAN_WILAYAS.map((w) => [w.id, w]));
