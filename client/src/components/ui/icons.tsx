...
export function IconTags(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M3 6.5A1.5 1.5 0 014.5 5H10l8 8-5 5-8-8V6.5z" />
      <circle cx="7.5" cy="9.5" r="1.1" fill="currentColor" stroke="none" />
      <path d="M14 5h4.5A1.5 1.5 0 0120 6.5V11l-3 3" />
    </svg>
  );
}
...
// Logos de marque : formes pleines (fill), pas le style contour de base().
...
export function IconTiktok(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.89-4.51 3 3 0 01.88.13V9.5a6.34 6.34 0 00-1-.08A6.34 6.34 0 105.7 20.09a6.34 6.34 0 0010.8-4.42V8.79a8.16 8.16 0 004.77 1.52V6.87a4.79 4.79 0 01-1.68-.18z" />
    </svg>
  );
}
...
export function IconEyeOff(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M6.61 6.61A13.52 13.52 0 002 12s3 7 10 7a9.74 9.74 0 005.39-1.61" />
